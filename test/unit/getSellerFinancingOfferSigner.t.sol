...
contract TestgetSellerFinancingOfferSigner is
    Test,
    BaseTest,
    ...
    OffersLoansFixtures
{
    ...
    function test_unit_getSellerFinancingOfferSigner() public {
        ...
        address signer = sellerFinancing.getSellerFinancingOfferSigner(offer, signature);
